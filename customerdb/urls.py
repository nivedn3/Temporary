...
from cd.views import sellerlogin,bargain,sellersignup,front,sellergcm,sellercategory,adv,feed,customer2seller,s2c,cus_conf,item,decline,userdata,updateuser
